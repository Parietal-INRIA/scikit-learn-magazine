...
language \cite{Rmanual} or the Weka Java toolkit \cite{hall2009weka}.
Of these, R is a custom \emph{language},
while Java is a library with a custom GUI.
The choice of Python ties machine learning into a general-purpose language
that allows interactive programming \cite{perez2007ipython},
with a single interface for
interactive work, scripting and full-blown applications.
...
predict new data. Because of overfitting, the \emph{train} data used for building
