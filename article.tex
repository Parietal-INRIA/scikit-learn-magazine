...
estimators. Typically, features used to build decisions indicate the
...
provides \emph{feature extraction} objects, that transform such
unstructured data into a data matrix. In these situations, the
$\textbf{X}$ matrix is a
matrix of counting statistics. It is full of zeros, in the sense that
