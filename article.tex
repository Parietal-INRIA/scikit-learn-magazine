...
yield the fraction of correct answers on three different folds:
\begin{lstlisting}
...
These large datasets present of course new technical challenges, in
...
handy. In scikit-learn, one could for instance resort to
random projections, that exploit the Johnson-Lindenstrauss lemma to give
good approximations of Euclidean distance in the datasets. In the
situation of a very large number of samples, some estimator expose
