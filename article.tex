...
comes to a crawl. The difficulty lies in defining the project scope and
prioritizing methods. We strive to integrate all classical methods that
are most useful for prediction tasks. We favor time-tested algorithm and
put great care in the choice of default parameters.
