...
institutions, with a variety of applications --xxx contributors total,
xxx active core contributors in the past year--. Indeed, not only is
there strength in numbers, but also the convergence of points of views
...
contribute with a tightly controlled process.
