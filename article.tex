...
\caption{On-line learning example: the main loop iterates through batches
of 1000 documents, vectorizing them on the fly and updating the
classifier. Running the example shows that the error on the test set
progressively decreases as data is accumulated.\label{fig:online}}
\end{figure*}
...
%
A full example doing online learning on a large corpus of text is given
on figure \ref{fig:online}.
